                ...
                <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false"
                    ...
                    <div role="content">
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="icon-addon addon-sm">
                                                    <select class="form-control col-md-10" name="" id="dt_supplier"
                                                            style="padding-right:50%" onchange="tampilData()">
                                                        <option selected="" value="00">----pilih semua Supplier----
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="col-md-3">
                                                <div class="icon-addon addon-sm">
                                                    <input type="text" class="form-control" id="due_date"
                                                           name="tgl_awal" placeholder="Due Date">
                                                    <label for="email" class="glyphicon glyphicon-list" rel="tooltip"
                                                           title="" data-original-title="email"></label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="icon-addon addon-sm">
                                                    <input class="form-control col-md-10" name="" id="pic"
                                                           style="padding-right:50%" readonly>
                                                    <label for="email" class="glyphicon glyphicon-user" rel="tooltip"
                                                           title=""></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="icon-addon addon-sm">
                                                    <input class="form-control col-md-3" name="" id="telepon"
                                                           style="padding-right:50%" readonly>
                                                    <label for="email" class="glyphicon glyphicon-phone-alt"
                                                           rel="tooltip" title=""></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="icon-addon addon-sm">
                                                    <input class="form-control col-md-10" name="" id="fax"
                                                           style="padding-right:50%" readonly>
                                                    <label for="email" class="glyphicon glyphicon-print" rel="tooltip"
                                                           title=""></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <textarea class="form-control" name="" id="alamat"
                                                          style="padding-right:50%" readonly></textarea>
                                            </div>
                                        </div>
                            </div>
                        ...
                        <form id="checkout-form" class="form-inline" role="form">
                            ...
                            <fieldset class="row">
                                <div class="col-md-12">
                                    <table id="table_addPo" class="table table-striped table-bordered table-hover"
                                           width="100%">
                                        <thead>
                                        <tr>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-12">
                                        <button class="btn-lg btn-block btn-primary text-center" onclick="simpanPo()">
                                            Buat Purchase Order
                                        </button>
                                    </div>
                                </div>
