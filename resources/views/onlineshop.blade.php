...
@section('content')
    ...
    <section class="section-slide">
        <div class="wrap-slick1 rs2-slick1">
            <div class="slick1">
                <div class="item-slick1 bg-overlay1" style="background-image: url({{asset('template_asset/frontend/images/slide-05.jpg')}});" data-thumb="{{asset('template_asset/frontend/images/thumb-01.jpg')}}" data-caption="Women’s Wear">
                ...
                <div class="item-slick1 bg-overlay1" style="background-image: url({{asset('template_asset/frontend/images/slide-06.jpg')}});" data-thumb="{{asset('template_asset/frontend/images/thumb-02.jpg')}}" data-caption="Men’s Wear">
                    <div class="container h-full">
                        <div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
                ...
                <div class="item-slick1 bg-overlay1" style="background-image: url({{asset('template_asset/frontend/images/slide-07.jpg')}});" data-thumb="{{asset('template_asset/frontend/images/thumb-03.jpg')}}" data-caption="Men’s Wear">
                    <div class="container h-full">
                        <div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    ...
                    <div class="block1 wrap-pic-w">
                        <img src="{{asset('template_asset/frontend/images/banner-01.jpg')}}" alt="IMG-BANNER')}}">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="{{asset('template_asset/frontend/images/banner-02.jpg')}}" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="{{asset('template_asset/frontend/images/banner-03.jpg')}}" alt="IMG-BANNER">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            ...
                            <div class="block2-txt-child2 flex-r p-t-3">
                                <a href="" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
                                    <img class="icon-heart1 dis-block trans-04" src="{{asset('template_asset/frontend/images/icons/icon-heart-01.png')}}"
                                        alt="ICON">
                                    <img class="icon-heart2 dis-block trans-04 ab-t-l" src="{{asset('template_asset/frontend/images/icons/icon-heart-02.png')}}"
                                        alt="ICON">
                                </a>
                            </div>
                        </div>
