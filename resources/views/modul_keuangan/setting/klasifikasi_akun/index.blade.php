    ...
    <div class="col-md-12" style="background: none; margin-bottom: 0px;" id="vue-component">
        ...
        <div class="col-md-12 table-content" style="background: none; box-shadow: none; margin-top: 8px;" v-cloak>
                <div class="row">
                    ...
                    <div class="col-md-9" id="main-content" v-if="stateNumber == 0">
                        <div class="row">
                    ...
                    <form id="data-form-lvl1" class="col-md-9" v-if="stateNumber == 1" style="padding: 0px;">
                    ...
                    <form id="data-form-lvlsubclass" class="col-md-9" v-if="stateNumber == 2" style="padding: 0px;">
                        <div class="col-md-12" id="main-content">
                            <div class="row">
                                <div class="col-md-12 title">
                    ...
                    <form id="data-form-lvl2" class="col-md-9" v-if="stateNumber == 3" style="padding: 0px;">
                        <div class="col-md-12" id="main-content">
                            <div class="row">
                                <div class="col-md-12 title">
                                                ...
                                                <table class="table table-stripped table-bordered table-mini">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="40%" class="text-center" style="position: sticky; top: 0px; background: white;"> Nama </td>
