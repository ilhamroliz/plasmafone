...
@section('title', 'Penjualan Regular')
...
@section('ribbon')
	...
	<div id="ribbon">
		...
		<ol class="breadcrumb">
			...
			<li>Home</li><li>Penjualan</li><li>Penjualan Regular</li>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				...
				<h1 class="page-title txt-color-blueDark">
					...
					Penjualan <span><i class="fa fa-angle-double-right"></i> Penjualan Regular </span>
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-align-right">
				...
				<div class="page-title">
					...
					<a href="{{ url('/penjualan-reguler/tambah') }}" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a>
						...
						<header>
							...
							<ul id="widget-tab-1" class="nav nav-tabs pull-left">
								...
								<li class="active" id="tab_aktif">
									...
									<a data-toggle="tab" href="#hr1"> <i style="color: #C79121;" class="fa fa-lg fa-align-justify"></i> <span class="hidden-mobile hidden-tablet"> Penjualan Regular </span> </a>
